...
namespace CreServicing.Agent.Tools;
...
public static class ServicingTools
{
    ...
    public static string GetLoanTerms(
    ...
    public static string ListPackageDocuments(
    ...
    public static string EvaluateCovenants(
    ...
    // (see ServicingAgentHost) rather than being gated here. That split matters:
    ...
    public static string CreateServicingException(
